...
def affine_normalize_relu_forward(x, w, b, gamma, beta, bn_param, normalization=None):
    '''
    Similar to affine_relu_foward but we add normalization layer in between
    ...
    if normalization == 'batchnorm':
        ...
        a, fc_cache = affine_forward(x, w, b)
        b, ln_cache = layernorm_forward(a, gamma, beta, bn_param)
        out, relu_cache = relu_forward(b)
...
def affine_normalize_relu_backward(dout, cache, normalization=None):
