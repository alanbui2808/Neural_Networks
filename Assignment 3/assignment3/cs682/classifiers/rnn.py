...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        x, cache_wording_embedding = word_embedding_forward(captions_in, W_embed)
        ...
        dW_embed = word_embedding_backward(dx, cache_wording_embedding)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(max_length):
          ...
          x = W_embed[next_word] # pick the next embedded word that has the highest score
          prev_h = next_h
